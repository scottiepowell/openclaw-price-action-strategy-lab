...
def test_blocked_candidates_do_not_get_journal_rows():
    case_paths = [_case_path(replay_id) for replay_id in ["HR-001", "HR-002", "HR-003", "HR-006", "HR-008", "HR-016", "HR-018"]]
...
def test_journal_readme_and_templates_include_manual_only_boundary():
    case_paths = [_case_path(replay_id) for replay_id in ["HR-004", "HR-005", "HR-009", "HR-017", "HR-019"]]
